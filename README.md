...
1. The system design document can be found here: [System Design Architecture](./docs/SYSTEM.md).
2. The sample app is the implementation for **Real-time Quiz Participation**. You can get more information on how to launch the sample in [App README](app/README.md) and [Client README](client/README.md).
3. [Scalability](./docs/SYSTEM.md#scallability), [Monitoring & Observebility](./docs/SYSTEM.md#monitoring-and-observability) can be found as a part in [Deployment Diagram](./docs/SYSTEM.md#deployment) of the System Design Architecture document.